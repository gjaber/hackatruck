//: ## Encerramento
//: Neste playground, definimos o que são os playgrounds e a barra lateral de resultados. Você também aprendeu várias coisas para mergulhar no caminho do programação:
