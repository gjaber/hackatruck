...
class Recorder: NSObject {
    ...
    // Iniciar o temporizador para gravar os frames
    func startRecording() {
    ...
    // Desenhar o robô e salvá-lo como frame.
    ...
    // Interromper a gravação e apresentar o botão Save
    ...
    // Apresentar um painel Save para o usuário
    ...
    // Gravar cada frame salvo como gif
